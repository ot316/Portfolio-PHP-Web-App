    ...
    <div class="wrapper">
        <div>
            ...
            <div id="spacing">
                ...
                <h2>How it Works</h2>
                <h3 style="padding: 10px;">Flow Diagram</h3>
                <img class="hero" style="padding: 10px; margin: auto; max-width: 250px; background-color: white" src="https://olithompson.s3.eu-west-2.amazonaws.com/Media/ISS_tracker/flow.png">
