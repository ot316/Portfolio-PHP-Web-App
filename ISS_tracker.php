    ...
    <div class="wrapper">
        <div>
            ...
            <div id="spacing">
                ...
                <img class="hero" style="padding-top: 10px; padding-bottom: 20px; max-width: 250px; background-color: white;" src="https://olithompson.s3.eu-west-2.amazonaws.com/Media/ISS_tracker/flow.png">
