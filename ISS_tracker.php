    ...
    <div class="wrapper">
        <div>
            ...
            <div id="spacing">
                ...
                <img class="hero" style="padding: 10px 10px 20px 10px; max-width: 250px; background-color: white" src="https://olithompson.s3.eu-west-2.amazonaws.com/Media/ISS_tracker/flow.png">
