    ...
    <div class="wrapper">
        <div>
            ...
            <ul class="headingbullets">
                <li>I designed a model of a PAL-V gyropcopter chassis using FEA, including analysis of frequency, fatigue and static loads in order to meet specific criteria.
                </li>
            </ul>
