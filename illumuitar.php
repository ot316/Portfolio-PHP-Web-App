...
<div class="background">
    ...
    <div class="wrapper">
        <div>
            <!-- Heading -->
            <img class="title" style="width: 60%; background-color: white; padding: 10px; margin-top: 25px;" src="https://olithompson.s3.eu-west-2.amazonaws.com/Media/Illumuitar/title.png" alt="Illumuitar">
