...
<div class="background">
    ...
    <div class="wrapper">
        <!-- Heading -->
        <img class="zggtitle" style="width: 30%; filter: invert(100); " src="https://olithompson.s3.eu-west-2.amazonaws.com/Media/zero_gravity_garden/Logo.png" alt="Zero Gravity Garden">
