    ...
    <div class="wrapper">
        <div>
            ...
            <ul class="headingbullets">
                <li>We designed the first portable electric ball launcher for dogs. This inclusive design project aimed to make owning a dog more accessable for the elderly. </li>
