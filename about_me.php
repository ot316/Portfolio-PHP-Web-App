...
<body class="background">
    ...
    <div class="wrapper">
        ...
        <br>
        <p style="display: block; margin-top: 0px;"> I am currently studying for an MSc in Computing Science at Imperial College London, having recently graduated with an MEng in Design Engineering (also at Imperial). Design Engineering is a course that combines traditional engineering skills with innovation and entrepreneurship. I am looking to pursue a career in product management, software engineering or related roles.</p>
